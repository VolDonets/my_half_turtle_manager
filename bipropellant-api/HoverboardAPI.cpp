 ...
 ***************************************************************************/
void
HoverboardAPI::sendSpeedData(double left_speed, double right_speed, int16_t max_power, int16_t min_speed, char som) {
    ...
    sendRawData(
            ...
            Codes::setSpeed,
            (unsigned char *) &writespeed,
            sizeof(writespeed.wanted_speed_mm_per_sec) + sizeof(writespeed.speed_max_power) +
            sizeof(writespeed.speed_min_power) + sizeof(writespeed.speed_minimum_speed),
            som
    );
}
